...
class _ClienteDropdownButtonState extends State<ClienteDropdownButton> {
  ...
  List<CategoriaModel> categorias = [
    ...
    CategoriaModel(id: 15, nome: "Advocacia"),
    CategoriaModel(id: 16, nome: "Finanças"),
    CategoriaModel(id: 17, nome: "Contabilidade"),
    CategoriaModel(id: 18, nome: "Agro Negocio"),
    CategoriaModel(id: 19, nome: "Lojas"),
    CategoriaModel(id: 20, nome: "Supermercado"),
    CategoriaModel(id: 21, nome: "Cartorários/Notariais"),
    CategoriaModel(id: 22, nome: "Clinica"),
    CategoriaModel(id: 23, nome: "Auto Eletrica"),
    CategoriaModel(id: 24, nome: "Auto Peças"),
    CategoriaModel(id: 25, nome: "Provedor de internet"),
  ];
